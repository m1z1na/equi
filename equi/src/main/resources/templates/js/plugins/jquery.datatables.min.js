...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Следующая",sPrevious:"Предыдущая"},sEmptyTable:"No data available in table",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показно 0 из 0, всего 0 записей",sInfoFiltered:"(Фильтер  по _MAX_ записям)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
